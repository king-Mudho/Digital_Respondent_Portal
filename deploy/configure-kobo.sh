...
if [[ -f "$STAGING_ENV" ]]; then
    for key in KOBO_ASSET_UID KOBO_API_TOKEN KOBO_FORM_URL KOBO_WEBHOOK_SHARED_SECRET KOBO_KII_ASSET_UID KOBO_DOCUMENTS_ASSET_UID KOBO_PROIT_ASSET_UID KOBO_DOCUMENTS_FORM_URL KOBO_KII_FORM_URL; do
