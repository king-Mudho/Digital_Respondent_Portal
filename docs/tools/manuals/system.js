...
module.exports = {
  ...
  blocks: [
    ...
    ["bullets", [
      ...
      "**Document records** need an authenticity assessment (Verified or Disputed) before they can be Included; an interpretive memo records reasoning. The source file is attached to the record (and can be removed if the wrong one was uploaded). Coding happens in the KoboToolbox Document Analysis Tool: **Code this document** opens it with the DOC ID filled in, and **Auto-fill** has AI draft the whole form from the source file for a Documentary RA to review, edit and submit. A PDF over 100 pages is coded by page range (for example one chapter) or read whole in parts and combined into one draft. The AI never submits on its own, and every draft is audited.",
    ]],
