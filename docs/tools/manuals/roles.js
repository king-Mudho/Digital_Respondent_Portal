...
module.exports = [
  ...
  guide({
    ...
    screens: [
      ...
      ["Form PDFs", "Completed document coding forms, and whether the portal matches KoboToolbox (Sync now)."],
      ["Documents", "The corpus; create records by uploading the document, and manage them."],
    ],
    routine: [
      ["When you find a source", "Documents → New document → upload the file (Quick add): the AI fills in the record and drafts the form. No file? Type the details, with a precise reference and an evidence extract."],
      ["Check the details", "Read the Record details on the record page and correct anything the AI got wrong."],
    ...
    trouble: [
      ...
      ["A record says “Already submitted” and is locked", "Its coding was already sent to KoboToolbox.", "To redo it, delete that record in KoboToolbox, then select **Sync now** on Form PDFs."],
